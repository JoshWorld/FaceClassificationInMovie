...
x_train, y_train, original_images = tensor_func.set_data('train_data')  # image load for cnn
...
x_test, y_test, original_img_list = tensor_func.set_data('test_data')  # image load for cnn
loss_val, accuracy_, class_prediction_, labels_batch_val = sess.run([loss_mean, accuracy, class_prediction, labels_batch],
